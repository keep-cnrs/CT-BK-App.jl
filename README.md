...
The CTBKApp.jl repo is part of the [control-toolbox ecosystem](https://github.com/control-toolbox).

| **Category** | **Badge** |
|-----------------------|-----------|
| **Documentation** | [![Stable Docs](https://img.shields.io/badge/docs-stable-blue.svg)](https://keep-cnrs.github.io/CTBKApp.jl/stable/) [![Dev Docs](https://img.shields.io/badge/docs-dev-8A2BE2.svg)](https://keep-cnrs.github.io/CTBKApp.jl/dev/) |
| **CI / Build** | [![Build Status](https://github.com/keep-cnrs/CTBKApp.jl/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/keep-cnrs/CTBKApp.jl/actions/workflows/CI.yml?query=branch%3Amain) |
| **Test Coverage** | [![Coverage](https://codecov.io/gh/keep-cnrs/CTBKApp.jl/branch/main/graph/badge.svg)](https://codecov.io/gh/keep-cnrs/CTBKApp.jl) |
| **Release / Version** | [![Release](https://img.shields.io/github/v/release/keep-cnrs/CTBKApp.jl.svg)](https://github.com/keep-cnrs/CTBKApp.jl/releases) |
| **License** | [![License](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/keep-cnrs/CTBKApp.jl/blob/master/LICENSE) |
...
[issue-url]: https://github.com/keep-cnrs/CTBKApp.jl/issues
[first-good-issue-url]: https://github.com/keep-cnrs/CTBKApp.jl/contribute
