...
The CT-BK-App.jl repo is part of the [control-toolbox ecosystem](https://github.com/control-toolbox).

| **Category** | **Badge** |
|-----------------------|-----------|
| **Documentation** | [![Stable Docs](https://img.shields.io/badge/docs-stable-blue.svg)](https://keep-cnrs.github.io/CT-BK-App.jl/stable/) [![Dev Docs](https://img.shields.io/badge/docs-dev-8A2BE2.svg)](https://keep-cnrs.github.io/CT-BK-App.jl/dev/) |
| **CI / Build** | [![Build Status](https://github.com/keep-cnrs/CT-BK-App.jl/actions/workflows/CI.yml/badge.svg?branch=main)](https://github.com/keep-cnrs/CT-BK-App.jl/actions/workflows/CI.yml?query=branch%3Amain) |
| **Test Coverage** | [![Coverage](https://codecov.io/gh/keep-cnrs/CT-BK-App.jl/branch/main/graph/badge.svg)](https://codecov.io/gh/keep-cnrs/CT-BK-App.jl) |
| **Release / Version** | [![Release](https://img.shields.io/github/v/release/keep-cnrs/CT-BK-App.jl.svg)](https://github.com/keep-cnrs/CT-BK-App.jl/releases) |
| **License** | [![License](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/keep-cnrs/CT-BK-App.jl/blob/master/LICENSE) |
...
[issue-url]: https://github.com/keep-cnrs/CT-BK-App.jl/issues
[first-good-issue-url]: https://github.com/keep-cnrs/CT-BK-App.jl/contribute
